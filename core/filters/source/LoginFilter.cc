                         ...
                         FilterChainCallback &&fccb)
{
    ...
    try{
        ...
        {
            throw stibel_init::exception::BusinessException(stibel_init::exception::ErrorCode::PARAMS_ERROR(), "LoginFilter::" + stibel_init::utils::UserDescription::NO_QUERY_PERMISSION());
        }
